<?php get_header(); ?>
    <div class="slide-one-item home-slider owl-carousel">
      <div class="site-blocks-cover overlay" style="background-image: url(/wp/wp-content/themes/gh/images/hero_1.jpg)"  data-aos="fade" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              ...
              <h1 class="mb-2 " id="gh" >Dewi Sri Guest House</h1>
        ...
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="img-border">
                <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                  ...
                  <img src="<?php bloginfo('template_url');?>/images/img_2.jpg" alt="" class="img-fluid">
                </a>
              </div>

              <img src="<?php bloginfo('template_url')?>/images/img_1.jpg" alt="Image" class="img-fluid image-absolute">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <div class="section-heading text-left">
              <h2 class="mb-5">About Our Guest House</h2>
            </div>
            <p class="mb-4">When my husband and I first laid eyes on this traditional balinese style house on the edge of Mataram City, we instanly fell in love. Although it was badly in need of repair, it’s charm and character really shone through. From the pretty french windows and timber shutters to the inviting front terrace and stone tiled floors, to the expansive front and back gardens, with frangipani, rambutan and manggo trees, it was as if we were being called, challenged even, to bring this fading beauty back to life. The landlord was more than happy to find someone who wanted to take the project on and after a short conversation we came to agreeable terms. The result is Dewi Sri Guesthouse, truly our labour of love.</p>
            <p><a href="about.html" class="popup-vimeo text-uppercase">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">Guest House Features</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="text-center p-4 item">
              <span class="flaticon-swimming-pool display-3 mb-3 d-block text-primary"></span>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="text-center p-4 item">
              <span class="flaticon-spa display-3 mb-3 d-block text-primary"></span>
              <h2 class="h5">Spa</h2>
            </div>
          </div>
          <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="media-with-text p-md-5">
              <div class="img-border-sm mb-4">
                <a href="#" class="popup-vimeo image-play">
                  <img src="<?php bloginfo('template_url');?>/images/img_1.jpg" alt="" class="img-fluid">
                </a>
              </div>
              <h2 class="heading mb-0"><a href="#">zuhrul azmi</a></h2>
